...
class OreProfileForecastContractTest {
    private static final ReferenceSummary EMPTY_REFERENCES = new ReferenceSummary(0, 0, 0, 0, 0, 0, List.of(), false);
    ...
    void constructorRejectsInvalidPagingMetadataAndOversizedIdentifiers() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> emptyForecast(OreProfileForecast.MAX_TOTAL_RULES + 1, 0, 12, 1));
        assertThrows(
                IllegalArgumentException.class,
                () -> new OreProfileForecast(
